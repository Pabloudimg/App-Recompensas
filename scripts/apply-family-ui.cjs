...
main = main.replace("import { ensureFamilyForUser, loadFamilyData, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStore'", "import { acceptFamilyInvite, createFamilyForUser, createFamilyInvite, ensureFamilyForUser, listPendingInvitesForEmail, listSentFamilyInvites, loadFamilyData, removePendingFamilyInvite, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStore'")
main = main.replace("import { acceptFamilyInvite, createFamilyForUser, createFamilyInvite, ensureFamilyForUser, listPendingInvitesForEmail, listSentFamilyInvites, loadFamilyData, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStoreV2'", "import { acceptFamilyInvite, createFamilyForUser, createFamilyInvite, ensureFamilyForUser, listPendingInvitesForEmail, listSentFamilyInvites, loadFamilyData, removePendingFamilyInvite, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStore'")
main = main.replace("import { acceptFamilyInvite, createFamilyForUser, createFamilyInvite, ensureFamilyForUser, listPendingInvitesForEmail, listSentFamilyInvites, loadFamilyData, removePendingFamilyInvite, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStoreV2'", "import { acceptFamilyInvite, createFamilyForUser, createFamilyInvite, ensureFamilyForUser, listPendingInvitesForEmail, listSentFamilyInvites, loadFamilyData, removePendingFamilyInvite, saveFamilyData, signInWithGoogle, signOut, subscribeToAuth } from './cloudStore'")
...
replaceOnce("            <h1>Level Up</h1>\n            <p className=\"hero-copy italic-copy\">Cumpra desafios, acumule estrelas e ganhe recompensas!</p>", "            <h1 className=\"brand-title\"><img className=\"brand-logo\" src={logoAppDataUri} alt=\"\" />Level Up</h1>\n            <p className=\"hero-copy italic-copy\">Cumpra desafios, acumule estrelas e ganhe recompensas!</p>")
...
`
  main = main.replace('function LoadingScreen() {', `${familySetupPanel}\nfunction LoadingScreen() {`)
}
...
.invite-list article { grid-template-columns: minmax(180px, 1fr) 120px 110px minmax(160px, 1fr) 105px; align-items: center; }
